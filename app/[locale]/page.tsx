              ...
              {[
                {
                  ...
                  desc:
                    locale === 'fr'
                      ? 'Livraison rapide entre les principales villes avec délais clairs.'
                      : locale === 'ar'
                      ? 'تسليم سريع بين المدن الرئيسية مع مواعيد واضحة.'
                      : 'Fast delivery between major cities and regions with clear ETAs.',
                },
                {
                  title:
                    locale === 'fr'
                  ...
                  desc:
                    locale === 'fr'
                      ? 'Paiement à la livraison, retours, et intégrations simples.'
                      : locale === 'ar'
                      ? 'دفع عند التسليم، معالجة المرتجعات، وتكامل بسيط مع متجرك.'
                      : 'Cash-on-delivery, returns handling, and simple integrations for online stores.',
                },
                {
                  title:
                    locale === 'fr'
                  ...
                  desc:
                    locale === 'fr'
                      ? 'Expéditions à l’international avec suivi et aide douanière.'
                      : locale === 'ar'
                      ? 'شحنات دولية مع تتبّع ودعم في الإجراءات الجمركية.'
                      : 'Cross-border shipping with tracking and customs support.',
                },
              ].map((item) => (
                <div
                  key={item.title}
              ...
              {[
                {
                  ...
                  desc:
                    locale === 'fr'
                      ? 'Réseau optimisé pour des livraisons rapides.'
                      : locale === 'ar'
                      ? 'شبكة محسّنة لتسليم أسرع.'
                      : 'Optimized routes and hubs for fast delivery.',
                },
                {
                  title:
                    locale === 'fr'
                  ...
                  desc:
                    locale === 'fr'
                      ? 'Statut en temps réel de l’enlèvement à la livraison.'
                      : locale === 'ar'
                      ? 'حالة الشحنة من الاستلام حتى التسليم في الوقت الحقيقي.'
                      : 'Real-time status from pickup to delivery.',
                },
                {
                  title:
                    locale === 'fr'
                  ...
                  desc:
                    locale === 'fr'
                      ...
                      : locale === 'ar'
                      ? 'فريق دعم متواجد عندما تحتاج إليه.'
                ...
                },
                {
                  ...
                  desc:
                    locale === 'fr'
                      ? 'De la petite boutique à la grande entreprise.'
                      : locale === 'ar'
                      ? 'من المشاريع الصغيرة إلى الشركات الكبرى.'
